...
class AdapterPdfViewed : RecyclerView.Adapter<AdapterPdfViewed.HolderPdfViewed>{
    //Context
    private val context: Context
    //ArrayList to hold books
    private var booksArrayList: ArrayList<ModelPdf>
    //view binding
    private lateinit var binding: RowPdfViewedBinding
    //constructor
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderPdfViewed {
        //bind/inflate row_pdf_favorite.xml
        binding = RowPdfViewedBinding.inflate(LayoutInflater.from(context), parent, false)

        return HolderPdfViewed(binding.root)
    }

    override fun onBindViewHolder(holder: HolderPdfViewed, position: Int) {
    ...
    private fun loadBookDetails(model: ModelPdf, holder: AdapterPdfViewed.HolderPdfViewed) {
        val bookId = model.id
    ...
    inner class HolderPdfViewed(itemView: View): RecyclerView.ViewHolder(itemView){
        //init UI Views
